<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="relative">
            ...
            <button type="button"
                class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-indigo-600 focus:outline-none bg-transparent"
                onclick="togglePasswordVisibility('update_password_current_password', 'eye-icon-current')"
                tabindex="-1"
            >
        ...
        <div class="relative">
            ...
            <button type="button"
                class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-indigo-600 focus:outline-none bg-transparent"
                onclick="togglePasswordVisibility('update_password_password', 'eye-icon-new')"
                tabindex="-1"
            >
        ...
        <div class="relative">
            ...
            <button type="button"
                class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-indigo-600 focus:outline-none bg-transparent"
                onclick="togglePasswordVisibility('update_password_password_confirmation', 'eye-icon-confirm')"
                tabindex="-1"
            >
