            ...
            <form action="{{ route('kriterias.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nama_kriteria" id="nama_kriteria" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    
                    <div>
                        <label for="keterangan_kriteria" class="block text-sm font-medium text-gray-700">Keterangan Kriteria</label>
                        <input type="text" name="keterangan_kriteria" id="keterangan_kriteria" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bobot" id="bobot" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
