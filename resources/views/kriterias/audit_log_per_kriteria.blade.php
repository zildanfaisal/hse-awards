<x-app-layout>
    <x-slot name="title">Audit Log Perubahan Kriteria: {{ $kriteria->nama_kriteria }}</x-slot>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Audit Log Perubahan Kriteria: ') }} {{ $kriteria->nama_kriteria }}
        </h2>
    </x-slot>
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg rounded-2xl p-8">
                <h3 class="font-bold text-lg mb-4">Riwayat Perubahan Kriteria Ini</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-xs">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100 text-center">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-center py-4 text-gray-500">Belum ada data perubahan untuk kriteria ini.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
