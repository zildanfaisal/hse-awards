            ...
            <form action="{{ route('subkriterias.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div class="mb-4">
                        ...
                        <select name="kriteria_id" id="kriteria_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_sub_kriteria" id="nama_sub_kriteria" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    
                    <div>
                        <label for="keterangan_sub_kriteria" class="block text-sm font-medium text-gray-700">Keterangan Sub-Kriteria</label>
                        <input type="text" name="keterangan_sub_kriteria" id="keterangan_sub_kriteria" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="nilai_sub_kriteria" class="block text-sm font-medium text-gray-700">Nilai Sub-Kriteria</label>
                        <input type="text" name="nilai_sub_kriteria" id="nilai_sub_kriteria" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
